...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-6 gap-10 max-w-5xl mx-auto font-sans">
      {/* Header */}
      ...
      {/* Preview */}
      <div className="relative group w-full max-w-2xl flex justify-center">
        ...
        <div className="relative bg-white dark:bg-[#0d1117] rounded-xl border border-gray-200 dark:border-gray-800 p-2 shadow-2xl">
          <img
            src={`/api?username=${debouncedUsername}`}
      ...
      <div className="w-full max-w-2xl space-y-3">
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={handleCopy}
            className={`text-xs px-3 py-1.5 rounded-md font-medium transition-all ${copied
